...
#Изначально х и у принимают тип данных any (то есть никакой), далее вы переводите их в int для сложения, а для ответа нужен строковый, поэтому используете str.
